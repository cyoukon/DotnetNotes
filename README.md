...
[总览.md](./设计模式/总览.md)
## 备忘录模式
[Memento.md](./设计模式/备忘录模式/Memento.md)
## 策略模式
...
## 单例模式
[Singleton.md](./设计模式/单例模式/Singleton.md)
## 迭代器模式
[Iterator.md](./设计模式/迭代器模式/Iterator.md)
## 访问者模式
...
## 简单工厂模式-不属于23种设计模式
[SimpleFactory.md](./设计模式/简单工厂模式-不属于23种设计模式/SimpleFactory.md)
## 建造者模式
[Builder.md](./设计模式/建造者模式/Builder.md)
## 解释器模式
[Interpreter.md](./设计模式/解释器模式/Interpreter.md)
## 命令模式
...
## 适配器模式
[Adapter.md](./设计模式/适配器模式/Adapter.md)
## 外观模式
[Facade.md](./设计模式/外观模式/Facade.md)
## 享元模式
[Flyweight.md](./设计模式/享元模式/Flyweight.md)
## 原型模式
...
## 装饰者模式
[Decorator.md](./设计模式/装饰者模式/Decorator.md)
## 状态模式
